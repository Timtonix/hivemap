defmodule HivemapWeb.UserAuthTest do
  use HivemapWeb.ConnCase, async: true

  alias Hivemap.Accounts
  alias Hivemap.Accounts.Scope
  alias HivemapWeb.UserAuth

  import Hivemap.AccountsFixtures

  @remember_me_cookie "_hivemap_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HivemapWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
